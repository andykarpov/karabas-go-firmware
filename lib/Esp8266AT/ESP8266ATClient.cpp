/******************************************************************************
Esp8266ATClient.cpp
Based on SparkFunESP8266Client.cpp
...
ESP8266Client::ESP8266Client(ESP8266Class* wifi, uint8_t sock)
{
	esp8266 = wifi;
	_socket = sock;
}

void ESP8266Client::begin(ESP8266Class* wifi)
{
	esp8266 = wifi;
}
