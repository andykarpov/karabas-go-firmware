...
#ifndef LOG_OUTPUT_DEBUG
#define LOG_OUTPUT_DEBUG            (0)
#endif
#ifndef LOG_OUTPUT_DEBUG_PREFIX
...
class ESP8266 {
 ...
 private:
    ...
    /* 
     * Recieve data from uart and search first target. Return true if target found, false for timeout.
     */
    bool recvUntil(String target, String &data, uint32_t timeout = 1000);
    ...
    bool sATCIPRECVTYPE(uint8_t mode);
    ...
    EspSerial *m_puart; /* The UART to communicate with ESP8266 */
